...
MIN_SUP = 0.03
K = 4
transactions, vocabulary, docs_of_words = readtransactions(
    'docword.test.txt', 'vocab.test.txt')
answer = apriori(MIN_SUP, K, transactions, vocabulary, docs_of_words)
numbersToWords(answer, vocabulary, "test_words_answer.txt")
...
numbersToWords(answer,vocabulary,"kos_words_answer_8_10.txt")
'''
...
answer = apriori(MIN_SUP,K,transactions,vocabulary,docs_of_words)
numbersToWords(answer,vocabulary,"enron_words_10_03.txt")
