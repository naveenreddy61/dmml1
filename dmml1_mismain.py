...
answer = MSapriori(test_transactions,test_docs_of_words,test_count_of_words,LS,beta,K)
numbersToWords(answer, test_vocabulary, "test_answer.txt")
'''
...
answer = MSapriori(kos_transactions,kos_docs_of_words,kos_count_of_words,LS,beta,K)
...
beta = 0.8
K = 5
enron_transactions, enron_vocabulary, enron_docs_of_words, enron_count_of_words = readtransactions(
    'docword.enron.txt', 'vocab.enron.txt')
num_enron_transactions = len(enron_transactions)
# print(getMIS(kos_docs_of_words,LS,beta,num_kos_transactions))
outputfile = open("enron_mis_answer.txt", "w")
for fk in MSapriori(enron_transactions, enron_docs_of_words, enron_count_of_words, LS, beta, K):
